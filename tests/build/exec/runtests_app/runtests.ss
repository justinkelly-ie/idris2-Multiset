...
(define csegen-13(delay (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8912 eta-0)))))) (lambda (u--a) (lambda (arg-9951) (lambda (eta-0) arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (lambda (world-4) (let ((act-5 (arg-9957 world-4))) (let ((act-3 (arg-9964 world-4))) (act-5 act-3)))))))))))
(define csegen-19(delay (vector (force csegen-13) (lambda (u--b) (lambda (u--a) (lambda (arg-10436) (lambda (arg-10439) (lambda (world-0) (let ((act-1 (arg-10436 world-0))) ((arg-10439 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10450) (lambda (world-0) (let ((act-1 (arg-10450 world-0))) (act-1 world-0))))))))
(define csegen-20(delay (cons (force csegen-19) (lambda (u--a) (lambda (arg-13044) arg-13044)))))
...
(define csegen-25 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-722 arg-725)))))
...
(define csegen-29 (cons (lambda (arg-8497) (lambda (arg-8500) (PreludeC-45InterfacesC-45BoolC-45Semigroup-u--C-60C-43C-62_Semigroup_AnyBool arg-8497 arg-8500))) 0))
(define PreludeC-45Types-prim__integerToNat (lambda (arg-0) (let ((sc0 (or (and (<= 0 arg-0) 1) 0))) (cond ((equal? sc0 0) 0)(else arg-0)))))
(define csegen-36 (vector (lambda (arg-5919) (lambda (arg-5922) (+ arg-5919 arg-5922))) (lambda (arg-5929) (lambda (arg-5932) (* arg-5929 arg-5932))) (lambda (arg-5939) (PreludeC-45Types-prim__integerToNat arg-5939))))
(define csegen-43 (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (case (vector-ref arg-8912 0) ((0) (let ((e-2 (vector-ref arg-8912 1))) (vector 0 e-2))) (else (let ((e-5 (vector-ref arg-8912 1))) (vector 1 (u--func e-5))))))))))
(define csegen-47 (vector csegen-43 (lambda (u--a) (lambda (arg-9951) (vector 1 arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (case (vector-ref arg-9957 0) ((0) (let ((e-2 (vector-ref arg-9957 1))) (vector 0 e-2))) (else (let ((e-5 (vector-ref arg-9957 1))) (case (vector-ref arg-9964 0) ((1) (let ((e-8 (vector-ref arg-9964 1))) (vector 1 (e-5 e-8)))) (else (let ((e-11 (vector-ref arg-9964 1))) (vector 0 e-11)))))))))))))
...
(define csegen-52 (vector csegen-47 (lambda (u--b) (lambda (u--a) (lambda (arg-10436) (lambda (arg-10439) (PreludeC-45Types-u--C-62C-62C-61_Monad_C-40EitherC-32C-36eC-41 arg-10436 arg-10439))))) (lambda (u--a) (lambda (arg-10450) (PreludeC-45Types-u--join_Monad_C-40EitherC-32C-36eC-41 arg-10450)))))
...
(define csegen-74 (lambda (eta-0) (lambda (eta-1) (cons eta-0 eta-1))))
(define PreludeC-45Types-u--toList_Foldable_C-40EitherC-32C-36eC-41 (lambda (ext-0) (PreludeC-45Types-u--foldr_Foldable_C-40EitherC-32C-36eC-41 csegen-74 '() ext-0)))
...
(define csegen-106 (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char arg-722 arg-725)))))
(define csegen-109 (vector (lambda (arg-5919) (lambda (arg-5922) (bs+ arg-5919 arg-5922 63))) (lambda (arg-5929) (lambda (arg-5932) (bs* arg-5929 arg-5932 63))) (lambda (arg-5939) (blodwen-toSignedInt arg-5939 63))))
...
(define csegen-137 (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (PreludeC-45TypesC-45List-mapAppend '() u--func arg-8912))))))
...
(define csegen-144(delay (SystemC-45Concurrency-makeChannel (force csegen-20))))
(define csegen-157 (cons (lambda (arg-8497) (lambda (arg-8500) (string-append arg-8497 arg-8500))) ""))
(define PreludeC-45Types-elemBy (lambda (arg-2 arg-3 arg-4) (let ((e-6 (vector-ref arg-2 5))) ((((e-6 'erased) 'erased) csegen-29) (arg-3 arg-4)))))
...
(define SystemC-45Info-isWindows ((PreludeC-45Types-elem (force csegen-98) csegen-25 SystemC-45Info-os) (cons "windows" (cons "mingw32" (cons "cygwin32" '())))))
...
(define DataC-45String-isPrefixOf (lambda (arg-0 arg-1) (DataC-45List-isPrefixOf csegen-106 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
...
(define SystemC-45Directory-n--3593-1650-u--C-62C-62C-61 (lambda (arg-1 arg-2 ext-0 ext-1) (PreludeC-45InterfacesC-45Monad-u--C-62C-62C-61_Monad_ComposeC-40C-40C-46C-32C-36mC-41C-32C-36tC-41 (force csegen-19) csegen-52 csegen-73 ext-0 ext-1)))
(define SystemC-45Directory-collectDir (lambda (arg-1 arg-2) (let ((e-2 (cdr arg-1))) ((e-2 'erased) (SystemC-45Directory-n--3593-1650-u--C-62C-62C-61 arg-1 arg-2 (SystemC-45Directory-nextDirEntry (force csegen-20) arg-2) (lambda (_-0) (if (null? _-0) (lambda (eta-0) (vector 1 '())) (let ((e-3 (unbox _-0))) (SystemC-45Directory-n--3593-1650-u--C-62C-62C-61 arg-1 arg-2 (SystemC-45Directory-collectDir (force csegen-20) arg-2) (lambda (u--ns) (lambda (eta-0) (vector 1 (cons e-3 u--ns)))))))))))))
...
(define TestC-45Golden-n--8205-4603-u--isTest (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (SystemC-45FileC-45Meta-exists (force csegen-20) (string-append arg-4 "/run"))))
...
(define TestC-45Golden-findTests (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (let ((act-1 ((SystemC-45Directory-listDir (force csegen-20) arg-3) ext-0))) (case (vector-ref act-1 0) ((1) (let ((e-2 (vector-ref act-1 1))) (let ((u--names (PreludeC-45Types-listBind e-2 (lambda (u--n) (PreludeC-45Types-listBind (PreludeC-45Interfaces-guard (vector (vector csegen-137 (lambda (u--a) (lambda (arg-9951) (PreludeC-45Types-u--pure_Applicative_List arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (PreludeC-45Types-u--C-60C-42C-62_Applicative_List arg-9957 arg-9964)))))) (lambda (u--a) '()) (lambda (u--a) (lambda (arg-10335) (lambda (arg-10338) (PreludeC-45TypesC-45List-tailRecAppend arg-10335 (arg-10338)))))) (arg-0 u--n)) (lambda (_-10677) (PreludeC-45Types-u--pure_Applicative_List u--n))))))) (let ((u--testNames (PreludeC-45Types-listBind u--names (lambda (u--n) (PreludeC-45Types-u--pure_Applicative_List (string-append arg-3 (string-append "/" u--n))))))) (TestC-45Golden-n--8205-4602-u--filter arg-3 arg-2 arg-1 arg-0 u--testNames ext-0))))) (else (let ((e-5 (vector-ref act-1 1))) ((System-die (force csegen-20) (string-append "failed to list " (string-append arg-3 (string-append ": " (SystemC-45FileC-45Error-u--show_Show_FileError e-5))))) ext-0)))))))
...
(define TestC-45Golden-pathLookup (lambda (arg-0 ext-0) (let ((act-1 ((System-getEnv (force csegen-20) "PATH") ext-0))) (let ((u--extensions (let ((sc0 SystemC-45Info-isWindows)) (cond ((equal? sc0 1) (cons ".exe" (cons ".cmd" (cons ".bat" (cons "" '()))))) (else (cons "" '())))))) (let ((u--pathList (DataC-45String-split (lambda (arg-1) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-1 SystemC-45Path-pathSeparator)) (DataC-45Maybe-fromMaybe (lambda () "/usr/bin:/usr/local/bin") act-1)))) (let ((u--candidates (PreludeC-45Types-listBind u--pathList (lambda (u--p) (PreludeC-45Types-listBind arg-0 (lambda (u--x) (PreludeC-45Types-listBind u--extensions (lambda (u--y) (PreludeC-45Types-u--pure_Applicative_List (string-append u--p (string-append "/" (string-append u--x u--y)))))))))))) ((SystemC-45FileC-45Meta-firstExists (force csegen-20) u--candidates) ext-0)))))))
(define TestC-45Golden-case--caseC-32blockC-32inC-32checkRequirement-4211 (lambda (arg-0 arg-1 ext-0) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (let ((act-1 ((System-getEnv (force csegen-20) e-2) ext-0))) (if (null? act-1) (TestC-45Golden-pathLookup e-3 ext-0) (let ((e-1 (unbox act-1))) (box e-1))))))))
...
(define TestC-45Golden-testReceiver (lambda (arg-0 arg-1 arg-2 arg-3) (cond ((equal? arg-3 0) (SystemC-45Concurrency-channelPut (force csegen-20) arg-2 arg-1))(else (let ((e-0 (- arg-3 1))) (lambda (world-0) (let ((act-1 ((SystemC-45Concurrency-channelGet (force csegen-20) arg-0) world-0))) (let ((u--nThreads (+ e-0 1))) (if (null? act-1) ((TestC-45Golden-testReceiver arg-0 arg-1 arg-2 e-0) world-0) (let ((e-1 (unbox act-1))) ((TestC-45Golden-testReceiver arg-0 (TestC-45Golden-updateSummary e-1 arg-1) arg-2 u--nThreads) world-0)))))))))))
(define TestC-45Golden-testSender (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-1 0) (lambda (clam-0) (if (null? arg-2) 'erased (let ((e-1 (car arg-2))) (let ((e-2 (cdr arg-2))) (let ((act-1 ((SystemC-45Concurrency-channelPut (force csegen-20) arg-0 (box e-1)) clam-0))) ((TestC-45Golden-testSender arg-0 arg-1 e-2) clam-0)))))))(else (let ((e-3 (- arg-1 1))) (lambda (clam-1) (if (null? arg-2) (let ((act-1 ((SystemC-45Concurrency-channelPut (force csegen-20) arg-0 '()) clam-1))) ((TestC-45Golden-testSender arg-0 e-3 '()) clam-1)) (let ((e-1 (car arg-2))) (let ((e-2 (cdr arg-2))) (let ((act-1 ((SystemC-45Concurrency-channelPut (force csegen-20) arg-0 (box e-1)) clam-1))) ((TestC-45Golden-testSender arg-0 arg-1 e-2) clam-1)))))))))))
...
(define DataC-45List-isInfixOfBy (lambda (arg-2 arg-3 arg-4) (PreludeC-45Types-u--foldMap_Foldable_List csegen-29 (lambda (eta-0) (DataC-45List-isPrefixOfBy arg-2 arg-3 eta-0)) (DataC-45List-tails arg-4))))
(define DataC-45List-isInfixOf (lambda (arg-1 ext-0 ext-1) (DataC-45List-isInfixOfBy (let ((e-1 (car arg-1))) e-1) ext-0 ext-1)))
(define DataC-45String-isInfixOf (lambda (arg-0 arg-1) (DataC-45List-isInfixOf csegen-106 (PreludeC-45Types-fastUnpack arg-0) (PreludeC-45Types-fastUnpack arg-1))))
...
(define System-getArgs (lambda (arg-1) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-0) (System-prim__getArgCount eta-0))))) (lambda (u--n) (let ((sc1 (PreludeC-45EqOrd-u--C-62_Ord_Int u--n (blodwen-toSignedInt 0 63)))) (cond ((equal? sc1 1) (PreludeC-45Basics-flip (lambda (arg-14091) (lambda (arg-14098) (PreludeC-45Types-u--traverse_Traversable_List (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) e-10)) arg-14091 arg-14098))) (PreludeC-45Types-u--rangeFromTo_Range_C-36a (cons (vector csegen-109 (lambda (arg-6334) (lambda (arg-6337) (PreludeC-45Num-u--div_Integral_Int arg-6334 arg-6337))) (lambda (arg-6344) (lambda (arg-6347) (PreludeC-45Num-u--mod_Integral_Int arg-6344 arg-6347)))) (cons (vector (cons (lambda (arg-712) (lambda (arg-715) (PreludeC-45EqOrd-u--C-61C-61_Eq_Int arg-712 arg-715))) (lambda (arg-722) (lambda (arg-725) (PreludeC-45EqOrd-u--C-47C-61_Eq_Int arg-722 arg-725)))) (lambda (arg-1594) (lambda (arg-1597) (PreludeC-45EqOrd-u--compare_Ord_Int arg-1594 arg-1597))) (lambda (arg-1604) (lambda (arg-1607) (PreludeC-45EqOrd-u--C-60_Ord_Int arg-1604 arg-1607))) (lambda (arg-1614) (lambda (arg-1617) (PreludeC-45EqOrd-u--C-62_Ord_Int arg-1614 arg-1617))) (lambda (arg-1624) (lambda (arg-1627) (PreludeC-45EqOrd-u--C-60C-61_Ord_Int arg-1624 arg-1627))) (lambda (arg-1634) (lambda (arg-1637) (PreludeC-45EqOrd-u--C-62C-61_Ord_Int arg-1634 arg-1637))) (lambda (arg-1644) (lambda (arg-1647) (PreludeC-45EqOrd-u--max_Ord_Int arg-1644 arg-1647))) (lambda (arg-1654) (lambda (arg-1657) (PreludeC-45EqOrd-u--min_Ord_Int arg-1654 arg-1657)))) (vector csegen-109 (lambda (arg-6034) (bs- 0 arg-6034 63)) (lambda (arg-6040) (lambda (arg-6043) (bs- arg-6040 arg-6043 63)))))) 0 (bs- u--n 1 63)) (lambda (eta-0) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-1) (System-prim__getArg eta-0 eta-1))))))) (else (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) '())))))))))))))
...
(define TestC-45GoldenC-45RunnerHelper-nproc (lambda (ext-0) (let ((act-1 ((System-getEnv (force csegen-20) "NUM_THREADS") ext-0))) (let ((sc0 (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe act-1 (lambda (eta-0) (DataC-45String-parsePositive csegen-36 eta-0))))) (if (null? sc0) (let ((act-2 ((System-run (force csegen-20) "nproc") ext-0))) (if (null? act-2) '() (let ((e-2 (car act-2))) (let ((e-3 (cdr act-2))) (cond ((equal? e-3 0) (DataC-45String-parsePositive csegen-36 e-2))(else '())))))) (let ((e-2 (unbox sc0))) (box e-2)))))))
...
(define TestC-45GoldenC-45RunnerHelper-testOptions (lambda (arg-0 arg-1 ext-0) (let ((act-1 (PreludeC-45IO-u--map_Functor_IO (lambda (eta-0) (DataC-45Maybe-filter (lambda (eta-1) (let ((sc0 (PreludeC-45Types-u--null_Foldable_List eta-1))) (cond ((equal? sc0 1) 0) (else 1)))) (DataC-45List-tailC-39 eta-0))) (System-getArgs (force csegen-20)) ext-0))) (let ((act-2 ((System-getEnv (force csegen-20) "NO_COLOR") ext-0))) (let ((act-3 (PreludeC-45IO-u--map_Functor_IO (lambda (arg-2) (PreludeC-45Types-u--C-47C-61_Eq_C-40MaybeC-32C-36aC-41 csegen-25 (box "true") arg-2)) (System-getEnv (force csegen-20) "CI") ext-0))) (let ((act-4 (TestC-45GoldenC-45RunnerHelper-nprocC-39 ext-0))) (let ((sc0 (TestC-45Golden-initOptions (arg-0 arg-1) 1))) (let ((e-0 (vector-ref sc0 0))) (let ((e-1 (vector-ref sc0 1))) (vector e-0 e-1 (PreludeC-45Types-u--map_Functor_Maybe (lambda (u--patterns) (lambda (u--test) (PreludeC-45Types-u--foldMap_Foldable_List csegen-29 (lambda (arg-2) (TestC-45GoldenC-45RunnerHelper-fitsPattern arg-2 u--test)) u--patterns))) act-1) act-3 (DataC-45Maybe-isNothing act-2) 1 act-4 (box "failures")))))))))))
(define TestC-45GoldenC-45RunnerHelper-goldenRunnerC-39 (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (let ((act-1 (PreludeC-45IO-u--map_Functor_IO (lambda (eta-0) 'erased) (SystemC-45Directory-changeDir (force csegen-20) arg-1) ext-0))) (let ((act-2 (TestC-45GoldenC-45RunnerHelper-testOptions arg-0 arg-2 ext-0))) (let ((act-3 (arg-3 ext-0))) (TestC-45Golden-runnerWith act-2 act-3 ext-0))))))
(define TestC-45GoldenC-45RunnerHelper-u--runScriptArg_RunScriptArg_R (lambda (arg-0) (string-append arg-0 "/.pack_lock")))
(define Tests-main (lambda (ext-0) (TestC-45GoldenC-45RunnerHelper-goldenRunnerC-39 (lambda (eta-0) (TestC-45GoldenC-45RunnerHelper-u--runScriptArg_RunScriptArg_R eta-0)) "/var/home/justin/Projects/Linear-Physics/idris2-Multiset-Advanced/tests" "/var/home/justin/Projects/Linear-Physics/idris2-Multiset-Advanced/tests/build" (lambda (eta-0) (TestC-45GoldenC-45RunnerHelperC-45TestPools-C-58C-58 csegen-0 (lambda (eta-1) (TestC-45GoldenC-45RunnerHelper-atDir "Definition Test" "definitions" eta-1)) (lambda (eta-1) (TestC-45GoldenC-45RunnerHelperC-45TestPools-C-58C-58 csegen-0 (lambda (eta-2) (TestC-45GoldenC-45RunnerHelper-atDir "Property Test" "properties" eta-2)) (lambda (eta-2) (TestC-45GoldenC-45RunnerHelperC-45TestPools-Nil eta-2)) eta-1)) eta-0)) ext-0)))
